                        ...
                        <div class="white-box">
                            <form action="<c:url value="/user/add"/>" method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <span class="col-md-12">${erroradd.getFullname()}</span>
                                </div>
                                <div class="form-group">
                                    <label for="example-email" class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input name="username" type="email" placeholder="johnathan@admin.com"
                                            class="form-control form-control-line" name="example-email"
                                            id="example-email"> </div>
                                    <span class="col-md-12">${erroradd.getEmail()}</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <span class="col-md-12">${erroradd.getPassword()}</span>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-12">
                                        <select name="roleId" class="form-control form-control-line">
                                            <c:forEach items="${role}" var="item" >
                                                <option value=${item.getId()}>${item.getName()} : ${item.getDescription()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
