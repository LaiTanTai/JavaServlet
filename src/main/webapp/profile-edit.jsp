            ...
            <div class="container-fluid">
                <div class="row bg-title">
                    <div class="col-lg-3 col-md-4 col-sm-4 col-xs-12">
                        <h4 class="page-title">Thông tin nhân viên
                        ...
                        <div class="white-box">
                            <form method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    <label class="col-md-12">Id nhân viên</label>
                                    <div class="col-md-12">
                                        <input name="userid" type="text"  value="${userid}" readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Tên nhân viên</label>
                                    <div class="col-md-12">
                                        <input name="fullnamenew" type="text"  placeholder="${fullname}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Email</label>
                                    <div class="col-md-12">
                                        <input name="emailnew" type="text"  placeholder="${email}" class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Chức vụ</label>
                                    <div class="col-md-12">
                                        <select name="rolenew" class="form-control form-control-line">
                                ...
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        ...
                                        <a href="<%=contextPath%>/user/look" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
