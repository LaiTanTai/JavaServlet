                        ...
                        <div class="white-box">
                            <form method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    <label class="col-md-12">ID quyền</label>
                                    <div class="col-md-12">
                                        <input name="idRole" type="text" value="${roleId}" readonly
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="nameRole" type="text" placeholder="${roleName}"
                                            class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="desRole" type="text" placeholder="${roleDescription}" class="form-control form-control-line" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-12">
                                        <button type="submit" class="btn btn-success">Reset Role</button>
                                        <a href="/CRM_project/role" class="btn btn-primary">Quay lại</a>
                                    </div>
                                </div>
                            </form>
                        </div>
