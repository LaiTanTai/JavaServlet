	...
	<div class="row">
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 class="counter text-right m-t-15 text-danger">${UserlistAmount.getNotDone()}%</h3>
                    </div>
                    <div class="col-xs-12">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="progress">
							<div class="progress-bar progress-bar-danger" role="progressbar"
								...
								style="width: ${UserlistAmount.getNotDone()}%"></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 class="counter text-right m-t-15 text-megna">${UserlistAmount.getInprocess()}%</h3>
                    </div>
                    <div class="col-xs-12">
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="progress">
							<div class="progress-bar progress-bar-megna" role="progressbar"
								aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
								style="width: ${UserlistAmount.getInprocess()}%"></div>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
			<div class="white-box">
				<div class="col-in row">
					<div class="col-xs-12">
						<h3 class="counter text-right m-t-15 text-primary">${UserlistAmount.getDone()}%</h3>
                    </div>
                    <div class="col-xs-12">
						<i class="linea-icon linea-basic" data-icon="&#xe00b;"></i>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="progress">
							<div class="progress-bar progress-bar-primary" role="progressbar"
								aria-valuenow="40" aria-valuemin="0" aria-valuemax="100"
								style="width: ${UserlistAmount.getDone()}%"></div>
						</div>
					</div>
				</div>
			</div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <c:forEach items="${UserlistAmount.getUserJobTaskList()}" var="item" >
                                <c:if test="${item.getStatus().equals('Chưa thực hiện')}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${item.getJobname()}</h5>
                                        <h6>${item.getTaskName()}</h6>
                                        <span class="mail-desc"></span>
                                        <span class="time">Bắt đầu: ${item.getStart_date()}</span>
                                        <span class="time">Kết thúc: ${item.getEnd_date()}</span>
                                    </div>
                                </a>
                                </c:if>
                            </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach items="${UserlistAmount.getUserJobTaskList()}" var="item" >
                                 <c:if test="${item.getStatus().equals('Đang thực hiện')}">
                                 <a href="#">
                                 <div class="mail-contnet">
                                     <h5>${item.getJobname()}</h5>
                                     <h6>${item.getTaskName()}</h6>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                                <c:forEach items="${UserlistAmount.getUserJobTaskList()}" var="item" >
                                <c:if test="${item.getStatus().equals('Đã hoàn thành')}">
                                <a href="#">
                                <div class="mail-contnet">
                                     <h5>${item.getJobname()}</h5>
                                     <h6>${item.getTaskName()}</h6>
