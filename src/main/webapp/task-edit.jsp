                        ...
                        <div class="white-box">
                            <form method="post" class="form-horizontal form-material">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="task_id" type="text" value="${taskID}" readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Dự án</label>
                                    <div class="col-md-12">
                                        <select name="projects" class="form-control form-control-line">
                                            <c:forEach items="${projectList}" var="item">
                                                <option value="${item.getId()}">${item.getProject_name()}</option>
                                            </c:forEach>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="task" type="text" placeholder="Tên công việc"
