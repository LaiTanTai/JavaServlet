                                ...
                                <table class="table" id="example">
                                    ...
                                    <c:forEach items="${taskList}" var="item">
                                        <tr>
                                            <td>${item.getId()}</td>
                                            <td>${item.getName()}</td>
                                            <td>${item.getProject()}</td>
                                            <td>${item.getUsername()}</td>
                                            <td>${item.getStart()}</td>
                                            <td>${item.getEnd()}</td>
                                            <td>${item.getStatus()}</td>
                                            <td>
                                                <a href="<%=contextPath%>/task/edit?task_id=${item.getId()}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="<%=contextPath%>/task/delete?task_id=${item.getId()}" class="btn btn-sm btn-danger">Xóa</a>
                                            </td>
                                        </tr>
                                    </c:forEach>
                                    </tbody>
