                        ...
                        <div class="white-box">
                            <form method="post" class="form-horizontal form-material">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-12">
                                        <input name="taskid" type="text"  value="${id}" readonly readonly class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Name</label>
                                    <div class="col-md-12">
                                        <input name="namenew" type="text"  value="${name}" disabled class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Project Name</label>
                                    <div class="col-md-12">
                                        <input name="jobnew" type="text"  value="${job}" disabled class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Start</label>
                                    <div class="col-md-12">
                                        <input name="startnew" type="text"  value="${start}" disabled class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">End</label>
                                    <div class="col-md-12">
                                        <input name="endnew" type="text"  value="${end}" disabled class="form-control form-control-line">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-md-12">Trạng thái</label>
                                    <div class="col-md-12">
                                        <select placeholder="${status}" name="statusnew" class="form-control form-control-line">
