...
<li style="padding: 10px 0 0;">
                        <a href="<%=contextPath%>/profile" class="waves-effect"><i class="fa fa-clock-o fa-fw"
                        ...
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-danger">${NotDone}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-danger" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${NotDone}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-megna">${Inprocess}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-megna" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${Inprocess}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
                        <div class="white-box">
                            <div class="col-in row">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-6">
                                    <h3 class="counter text-right m-t-15 text-primary">${Done}%</h3>
                                </div>
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <div class="progress">
                                        <div class="progress-bar progress-bar-primary" role="progressbar"
                                            aria-valuenow="40" aria-valuemin="0" aria-valuemax="100" style="width: ${Done}%">
                                        </div>
                                    </div>
                                </div>
                            </div>
                   ...
                   <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <c:forEach items="${items.getTaskList()}" var="Itemget">
                            <c:if test="${Itemget.getStatus().equals('Chưa thực hiện')}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${Itemget.getName()}</h5> <span class="mail-desc">Just see the my admin!</span>
                                        <span class="time">${Itemget.getStart()} => ${Itemget.getEnd()}</span>
                                    </div>
                                </a>
                            </c:if>
                            </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            <c:forEach items="${items.getTaskList()}" var="Itemgot">
                            <c:if test="${Itemgot.getStatus().equals('Đang thực hiện')}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${Itemgot.getName()}</h5> <span class="mail-desc">Just see the my admin!</span>
                                        <span class="time">${Itemgot.getStart()} => ${Itemgot.getEnd()}</span>
                                    </div>
                                </a>
                            </c:if>
                            </c:forEach>
                    ...
                    <div class="col-md-4">
                        <div class="white-box">
                            ...
                            <div class="message-center">
                            <c:forEach items="${items.getTaskList()}" var="Itemgotten">
                            <c:if test="${Itemgotten.getStatus().equals('Đã hoàn thành')}">
                                <a href="#">
                                    <div class="mail-contnet">
                                        <h5>${Item.getName()}</h5> <span class="mail-desc">Just see the my admin!</span>
                                        <span class="time">${Itemgotten.getStart()} => ${Itemgotten.getEnd()}</span>
                                    </div>
                                </a>
                            </c:if>
                            </c:forEach>
