                                ...
                                <table class="table" id="example">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="<%=contextPath%>/role/edit?role_id=${item.getId()}&role_name=${item.getName()}&role_des=${item.getDescription()}" class="btn btn-sm btn-primary">Sửa</a>
                                                <a href="<%=contextPath%>/role/delete?roleId=${item.getId()}" class="btn btn-sm btn-danger">Xóa</a>
                                            </td>
                                        </tr>
                                        </c:forEach>
                                    </tbody>
